...
export default function GoogleLensConfig() {
  ...
  const t = {
    EN: {
      title: "AG3 Google Lens/Visual Search Config",
      desc: "Choose the AG3 Google Lens/Visual Search provider, fallback, keys, proxy, language, and result limits.",
      provider: "AG3 Provider",
      ...
      enableAgent3: "Enable AG3 Google Lens/Visual Search",
      ...
      save: "Save Changes",
      refresh: "Refresh",
      updated: "AG3 Google Lens/Visual Search configuration saved.",
      loadFailed: "Failed to load Google Lens config.",
      saveFailed: "Failed to save Google Lens config.",
    },
    VI: {
      title: "Cấu hình AG3 Google Lens/Visual Search",
      desc: "Chọn nhà cung cấp, fallback, key, proxy, ngôn ngữ và giới hạn kết quả cho AG3 Google Lens/Visual Search.",
      provider: "Nhà cung cấp AG3",
      ...
      enableAgent3: "Bật AG3 Google Lens/Visual Search",
      ...
      save: "Lưu thay đổi",
      refresh: "Tải lại",
      updated: "Đã lưu cấu hình AG3 Google Lens/Visual Search.",
